...
BOT_TOKEN = "8413316921:AAHdiBMUNzFhrh36rgZ0izKq7C6OWmSazTI"
...
def updates_handler(message):
    bot.send_message(message.chat.id, "📢 Join our channel: https://t.me/+yk3vdSeF9YJjMDE1")

@bot.message_handler(func=lambda m: m.text == "📞 Contact Owner")
def contact_handler(message):
    bot.send_message(message.chat.id, "📞 Contact: @nayakxcheats")
...
if __name__ == "__main__":
    logger.info("Starting 24x7 Nayak Hosting Bot...")
    start_bot()